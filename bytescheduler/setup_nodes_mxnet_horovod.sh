...
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.86.139 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.81.16 "echo $id2translate >>~/.ssh/authorized_keys"
...
nvidia-docker run -it --gpus all --ipc=host --name mlnet-analysis-mxnet-horovod --network host -v /home/ubuntu/byteps:/home/cluster/byteps --detach 85882e303581
