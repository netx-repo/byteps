...
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.69.205 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.65.175 "echo $id2translate >>~/.ssh/authorized_keys"
