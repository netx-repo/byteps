...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.81.161 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.81.138 "echo $id2translate >>~/.ssh/authorized_keys"
