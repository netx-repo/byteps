...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@52.87.137.30 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@18.234.102.34 "echo $id2translate >>~/.ssh/authorized_keys"
