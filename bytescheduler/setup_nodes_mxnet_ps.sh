...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.65.42 "echo $id2translate >>~/.ssh/authorized_keys"
...
nvidia-docker run -it --gpus all --ipc=host --name mlnet-analysis --network host -v /home/ubuntu/byteps:/home/cluster/byteps --detach 3bd07e3d8b5d
