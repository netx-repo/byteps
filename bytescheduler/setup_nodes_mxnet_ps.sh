...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.21.133 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.25.63 "echo $id2translate >>~/.ssh/authorized_keys"
