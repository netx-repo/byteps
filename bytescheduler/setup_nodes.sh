...
#ssh -i ~/byteps/bytescheduler/bytescheduler-20201004.pem ubuntu@172.31.18.192 "echo $id2translate >>~/.ssh/authorized_keys"

cd ~/
# setup docker and connect to container
# mxnet ps t4 
docker login -u rivendile -p zhyh19980824
docker pull rivendile/bsc-mxnet-ps-ssh-t4-myps-pip:ps-update
nvidia-docker run -it --gpus all --ipc=host --name mlnet-analysis --network host -v /home/ubuntu/byteps:/home/cluster/byteps --detach 0fcd2b318501
