...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.73.105	"echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@172.31.75.197 "echo $id2translate >>~/.ssh/authorized_keys"
