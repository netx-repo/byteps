...
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@34.229.119.81 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler/bytescheduler-0105.pem ubuntu@35.171.159.99 "echo $id2translate >>~/.ssh/authorized_keys"
