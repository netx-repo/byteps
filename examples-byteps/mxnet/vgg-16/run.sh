...
bpslaunch python3 train_imagenet.py --network vgg --num-layers 16 --batch-size 32 --benchmark 1 --num-examples 3232 --num-epochs 1 --disp-batches 10 >/home/cluster/byteps/examples-byteps/mxnet/vgg-16/test.txt 2>&1 $@
