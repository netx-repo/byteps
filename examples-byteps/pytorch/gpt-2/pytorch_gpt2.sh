...
pkill python
cd /home/cluster/byteps
rm -rf examples
mv /home/cluster/examples /home/cluster/byteps
cd /home/cluster/byteps/examples/pytorch/gpt-2/gpt-2/examples

pkill python
vim /home/cluster/byteps/examples/pytorch/gpt-2/gpt-2/examples/run_lm_finetuning_bps.py
...
cd /home/cluster/byteps
rm -rf examples
git clone https://github.com/Rivendile/examples.git
...
docker stop mlnet-analysis-byteps-pytorch  && docker rm mlnet-analysis-byteps-pytorch
