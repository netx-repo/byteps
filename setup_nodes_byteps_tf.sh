...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.65.36 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.64.215 "echo $id2translate >>~/.ssh/authorized_keys"
