...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.37.165 "echo $id2translate >>~/.ssh/authorized_keys"
...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.43.76 "echo $id2translate >>~/.ssh/authorized_keys"
