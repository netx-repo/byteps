...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.73.66 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.70.250 "echo $id2translate >>~/.ssh/authorized_keys"
