...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.65.77 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.75.231 "echo $id2translate >>~/.ssh/authorized_keys"
...
#ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.21.79 "echo $id2translate >>~/.ssh/authorized_keys"
