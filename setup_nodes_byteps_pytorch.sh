...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.26.209 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.29.85 "echo $id2translate >>~/.ssh/authorized_keys"
