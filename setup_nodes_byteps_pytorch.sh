...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.72.66 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.76.77 "echo $id2translate >>~/.ssh/authorized_keys"
