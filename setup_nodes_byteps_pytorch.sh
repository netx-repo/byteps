...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.80.30 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.82.160 "echo $id2translate >>~/.ssh/authorized_keys"
