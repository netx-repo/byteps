...
ssh -i ~/byteps/bytescheduler-0105.pem ubuntu@172.31.38.29 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-0105.pem ubuntu@172.31.46.17 "echo $id2translate >>~/.ssh/authorized_keys"
