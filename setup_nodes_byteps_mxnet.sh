...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.16.208 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.19.194 "echo $id2translate >>~/.ssh/authorized_keys"
