...
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.25.94 "echo $id2translate >>~/.ssh/authorized_keys"
ssh -i ~/byteps/bytescheduler-20201004.pem ubuntu@172.31.21.195 "echo $id2translate >>~/.ssh/authorized_keys"
